...
export const PokemonCards = ({pokemon}:Props) => {
  ...
  return (
    ...
    <div className="relative pt-10 px-10 flex items-center justify-center">
      ...
      <Image className="relative w-40" src="https://user-images.githubusercontent.com/2805249/64069998-305de300-cc9a-11e9-8ae7-5a0fe00299f2.png" alt="" width={500} height={300}/>
    </div>
